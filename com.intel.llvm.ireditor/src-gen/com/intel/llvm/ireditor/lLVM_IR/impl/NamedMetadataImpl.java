...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Named Metadata</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.NamedMetadataImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.NamedMetadataImpl#getNode <em>Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamedMetadataImpl extends TopLevelElementImpl implements NamedMetadata
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.NAMED_METADATA__NAME, oldName, name));
  }
  ...
  public void setNode(MetadataNode newNode)
  {
    if (newNode != node)
    {
      ...
      if (newNode != null)
        msgs = ((InternalEObject)newNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.NAMED_METADATA__NODE, null, msgs);
      msgs = basicSetNode(newNode, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.NAMED_METADATA__NODE, newNode, newNode));
  }
