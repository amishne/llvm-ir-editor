...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vector Instructions</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.VectorInstructionsImpl#getOpcode <em>Opcode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VectorInstructionsImpl extends MinimalEObjectImpl.Container implements VectorInstructions
{
  /**
  ...
  public void setOpcode(String newOpcode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.VECTOR_INSTRUCTIONS__OPCODE, oldOpcode, opcode));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LLVM_IRPackage.VECTOR_INSTRUCTIONS__OPCODE:
        return getOpcode();
    }
