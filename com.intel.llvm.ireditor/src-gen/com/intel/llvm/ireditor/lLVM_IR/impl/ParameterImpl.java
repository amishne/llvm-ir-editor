 ...
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends LocalValueImpl implements Parameter
{
  ...
  public void setType(ParameterType newType)
  {
    if (newType != type)
    {
      ...
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.PARAMETER__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.PARAMETER__TYPE, newType, newType));
  }
