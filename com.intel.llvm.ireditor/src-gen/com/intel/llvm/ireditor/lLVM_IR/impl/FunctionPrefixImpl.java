...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Prefix</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.FunctionPrefixImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionPrefixImpl extends MinimalEObjectImpl.Container implements FunctionPrefix
{
  ...
  public void setValue(TypedConstant newValue)
  {
    if (newValue != value)
    {
      ...
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.FUNCTION_PREFIX__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.FUNCTION_PREFIX__VALUE, newValue, newValue));
  }
