...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Other Instruction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.OtherInstructionImpl#getOpcode <em>Opcode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OtherInstructionImpl extends MinimalEObjectImpl.Container implements OtherInstruction
{
  /**
   ...
   * @generated
   */
  protected OtherInstructionImpl()
  {
    super();
  }
  ...
  public void setOpcode(String newOpcode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.OTHER_INSTRUCTION__OPCODE, oldOpcode, opcode));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LLVM_IRPackage.OTHER_INSTRUCTION__OPCODE:
        return getOpcode();
    }
