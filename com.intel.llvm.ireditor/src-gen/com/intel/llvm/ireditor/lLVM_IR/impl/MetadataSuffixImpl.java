...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Metadata Suffix</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.MetadataSuffixImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.MetadataSuffixImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetadataSuffixImpl extends MinimalEObjectImpl.Container implements MetadataSuffix
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.METADATA_SUFFIX__NAME, oldName, name));
  }
  ...
  public void setValue(MetadataRef newValue)
  {
    if (newValue != value)
    {
      ...
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.METADATA_SUFFIX__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.METADATA_SUFFIX__VALUE, newValue, newValue));
  }
