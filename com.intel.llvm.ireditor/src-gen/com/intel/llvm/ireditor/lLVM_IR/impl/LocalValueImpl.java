 ...
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.LocalValueImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LocalValueImpl extends MinimalEObjectImpl.Container implements LocalValue
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.LOCAL_VALUE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LLVM_IRPackage.LOCAL_VALUE__NAME:
        return getName();
    }
