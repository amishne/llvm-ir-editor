 ...
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.TypeDefImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.TypeDefImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeDefImpl extends TopLevelElementImpl implements TypeDef
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.TYPE_DEF__NAME, oldName, name));
  }
  ...
  public void setType(NonVoidType newType)
  {
    if (newType != type)
    {
      ...
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.TYPE_DEF__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.TYPE_DEF__TYPE, newType, newType));
  }
