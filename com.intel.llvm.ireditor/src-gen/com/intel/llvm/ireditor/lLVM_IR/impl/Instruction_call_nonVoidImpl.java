...
public class Instruction_call_nonVoidImpl extends MinimalEObjectImpl.Container implements Instruction_call_nonVoid
{
  ...
  public NotificationChain basicSetCconv(CConv newCconv, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__CCONV, oldCconv, newCconv);
  ...
  public void setCconv(CConv newCconv)
  {
    if (newCconv != cconv)
    {
      ...
      if (cconv != null)
        msgs = ((InternalEObject)cconv).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__CCONV, null, msgs);
      if (newCconv != null)
        msgs = ((InternalEObject)newCconv).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__CCONV, null, msgs);
      msgs = basicSetCconv(newCconv, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__CCONV, newCconv, newCconv));
  }
