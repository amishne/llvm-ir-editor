...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Non Left Recursive Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.NonLeftRecursiveTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.NonLeftRecursiveTypeImpl#getTypedef <em>Typedef</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NonLeftRecursiveTypeImpl extends MinimalEObjectImpl.Container implements NonLeftRecursiveType
{
  ...
  public void setType(EObject newType)
  {
    if (newType != type)
    {
      ...
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LLVM_IRPackage.NON_LEFT_RECURSIVE_TYPE__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.NON_LEFT_RECURSIVE_TYPE__TYPE, newType, newType));
  }
  ...
  public void setTypedef(TypeDef newTypedef)
  {
    ...
    typedef = newTypedef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.NON_LEFT_RECURSIVE_TYPE__TYPEDEF, oldTypedef, typedef));
  }
